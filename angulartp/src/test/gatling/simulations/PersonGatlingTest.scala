...
class PersonGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Person entity")
        ...
        .repeat(2) {
            ...
            .put("/api/persons")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "nom":"SAMPLE_TEXT", "prenom":"SAMPLE_TEXT", "genre":"SAMPLE_TEXT", "mail":"SAMPLE_TEXT", "datenaiss":"2020-01-01T00:00:00.000Z", "profil":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
